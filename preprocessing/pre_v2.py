...
if __name__ == "__main__":
    ...
    folder_path_data = "C:/Users/21398/Desktop/sophomore/SRTP/data/original_frame_data/processed_dataset/processed_dataset/device_3/data"
    '''
    ...
    base_path = r"C:\Users\21398\Desktop\sophomore\SRTP\data\original_frame_data\processed_dataset\processed_dataset"
    # 将处理之后的前导码存到这个路径下
    dest_base_path = r"C:\Users\21398\Desktop\sophomore\SRTP\data\preamble_data"
    ...
    for folder in folders:
        data_folder = os.path.join(base_path, folder, "data") # dataset_1229\dataset_1229\processed_dataset\de1\data
        if os.path.exists(data_folder):
            print(f"开始处理 {data_folder} 中的文件...")
            dest_path = os.path.join(dest_base_path, folder)  # 指定新文件夹路径 preamble_data\de1
            try:
                # 创建文件夹
                os.mkdir(dest_path)
            ...
            for file_name in os.listdir(data_folder):
                file_path = os.path.join(data_folder, file_name) # dataset_1229\dataset_1229\processed_dataset\de1\data\1
                if os.path.isfile(file_path):
                    save_path = os.path.join(dest_path,file_name) # 存储地址 preamble_data\de1\1
                    # 示例处理：读取内容、转换为大写
